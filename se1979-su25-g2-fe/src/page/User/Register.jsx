        ...
        <div className="min-h-screen bg-gray-50 flex">
            ...
            <div className="hidden lg:flex lg:w-1/2 bg-white items-center justify-center p-12">
                <div className="text-center">
                    <div className="w-64 h-48 bg-black rounded-lg flex items-center justify-center mb-8 mx-auto">
                        <div className="text-white">
                            <div className="w-16 h-12 bg-white rounded mb-4 mx-auto flex items-center justify-center">
                                <div className="w-8 h-8 bg-black rounded-full relative">
                                    <div className="absolute top-1 right-1 w-2 h-2 bg-white rounded-full"></div>
                                    <div className="absolute bottom-0 left-0 w-6 h-4 bg-black transform rotate-45"></div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
                <div className="w-full max-w-md">
                    <div className="bg-white rounded-lg shadow-lg p-8">
                        ...
                        {/* Social Login */}
                        <div className="mt-6">
                            <p className="text-center text-gray-600 text-sm mb-4">hoặc đăng nhập với</p>
