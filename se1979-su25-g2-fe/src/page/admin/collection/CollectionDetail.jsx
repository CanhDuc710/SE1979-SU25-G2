...
const CollectionDetail = () => {
    ...
    return (
        <div className="max-w-xl mx-auto p-8 bg-gradient-to-br from-blue-100 via-yellow-50 to-pink-100 rounded-2xl shadow-lg border border-blue-200">
            ...
            <h2 className="text-2xl font-extrabold mb-6 text-center text-blue-700 drop-shadow">Collection Detail</h2>
            ...
            <div className="mt-8">
                <div className="font-semibold text-blue-800 mb-2">Products in this Collection:</div>
